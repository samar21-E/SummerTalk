...
const rtmpCfg = {
    ...
    appName: 'Summertalk',
    streamKey: '',
    secret: 'SummertalkRtmpSecret', // Must match the key in node-media-server/src/config.js if play and publish are set to true, otherwise leave it ''
    apiSecret: 'SummertalkRtmpApiSecret', // Must match the apiSecret specified in the Client side.
    expirationHours: 4,
};
