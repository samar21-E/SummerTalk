...
async function shareRoom(useNavigator = false) {
    ...
    function share() {
        ...
        Swal.fire({
            ...
            <p style="background:transparent; color:white; font-family: Arial, Helvetica, sans-serif;">Give Your Friends the QR code or the URL</p>
...
function leaveFeedback() {
    Swal.fire({
        ...
        text: 'Do you want to rate your SummerTalk experience?',
...
function showAbout() {
    ...
    Swal.fire({
        ...
        title: BRAND.about?.title && BRAND.about.title.trim() !== '' ? BRAND.about.title : 'WebRTC SFU v1.8.29',
        html: `
            <br />
            <div id="about">
                ${
                    BRAND.about?.html && BRAND.about.html.trim() !== ''
                        ...
                        : `
                            <button 
                                ...
                                onclick="window.open('https://codecanyon.net/user/Samar', '_blank')">
                            ...
                            <a 
                                ...
                                href="https://www.linkedin.com/in/Summerslav-pejic-976a07101/" 
                                target="_blank"> 
                                Samar Hassine
                            </a>
                            <br /><br />
                            ...
                            <a 
                                ...
                                href="mailto:Summerslav.pejic.85@gmail.com?subject=SummerTalk info"> 
                                Summerslav.pejic.85@gmail.com
                            </a>
                            <br /><br />
                            <hr />
                            <span>&copy; 2025 SummerTalk, all rights reserved</span>
                            <hr />
                        `
                }
            </div>
