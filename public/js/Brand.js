...
let BRAND = {
    app: {
        language: 'en',
        name: 'SummerTalk',
        title: 'SummerTalk<br />Free browser based Real-time video calls.<br />Simple, Secure, Fast.',
        description:
            'Start your next video call with a single click. No download, plug-in, or login is required. Just get straight to talking, messaging, and sharing your screen.',
        joinDescription: 'Join Summer Talk.<br />How about this one?',
    ...
    meta: {
        description:
            'SummerTalk powered by WebRTC and mediasoup, Real-time Simple Secure Fast video calls, messaging and screen sharing capabilities in the browser.',
        keywords:
            'webrtc, Summer, mediasoup, mediasoup-client, self hosted, voip, sip, real-time communications, chat, messaging, meet, webrtc stun, webrtc turn, webrtc p2p, webrtc sfu, video meeting, video chat, video conference, multi video chat, multi video conference, peer to peer, p2p, sfu, rtc, alternative to, zoom, microsoft teams, google meet, jitsi, meeting',
    },
    html: {
        features: true,
        teams: true,
    ...
    about: {
        imageUrl: '../images/Summertalk-logo.gif',
        title: '<strong>WebRTC SFU v1.8.29</strong>',
        html: `
            <button 
                id="support-button" 
