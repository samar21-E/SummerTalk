...
const image = {
    about: '../images/Summertalk-logo.gif',
    avatar: '../images/Summertalksfu-logo.png',
...
class RoomClient {
    ...
    selectFileToShare(peer_id, broadcast = false) {
        ...
        Swal.fire({
            allowOutsideClick: false,
            background: swalBackground,
            imageAlt: 'Summertalksfu-file-sharing',
        ...
        if (isImageURL(this.incomingFileInfo.fileName)) {
            ...
            reader.onload = (e) => {
                Swal.fire({
                    ...
                    imageAlt: 'Summertalksfu-file-img-download',
                    showDenyButton: true,
                    confirmButtonText: `Save`,
                    denyButtonText: `Cancel`,
                    showClass: { popup: 'animate__animated animate__fadeInDown' },
