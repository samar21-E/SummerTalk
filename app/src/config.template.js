...
/**
 * ==============================================
 * SummerTalk - Configuration File
 * ==============================================
 *
 * This file contains all configurable settings for the SummerTalk application.
...
const ANNOUNCED_IP = '18.196.185.52'
...
module.exports = {
    ...
    server: {
         ...
         */
        hostUrl: 'https://18.196.185.52:3010',
        listen: {
    ...
    media: {
         ...
         * - secret             : Must match NodeMediaServer's config.js (default: 'SummertalkRtmpSecret')
         * - apiSecret          : WebRTC→RTMP API secret (default: 'SummertalkRtmpApiSecret')
         ...
         * Server Management
         * ----------------
         * NodeMediaServer (Summertalk/nms:latest):
         *   - Start: npm run nms-start
         *   - Stop:  npm run nms-stop
         *   - Logs:  npm run nms-logs
         *
         * NGINX-RTMP (Summertalk/rtmp:latest):
         ...
         * Documentation:
         * --------------
         * - https://docs.Summertalk.com/Summertalk-sfu/rtmp/
         */
        rtmp: {
            ...
            secret: process.env.RTMP_SECRET || 'SummertalkRtmpSecret',
            apiSecret: process.env.RTMP_API_SECRET || 'SummertalkRtmpApiSecret',
    ...
    security: {
         ...
         */
        jwt: {
            key: process.env.JWT_SECRET || 'Summertalksfu_jwt_secret',
        ...
        oidc: {
            ...
            config: {
                ...
                secret: process.env.OIDC_SECRET || 'Summertalksfu-oidc-secret',
         ...
         * - users_from_db      : Fetch authorized users from database/API instead of local config (eg., SummerTalk WEB)
         *
         * API Integration:
         * ----------------
         ...
         * Documentation:
         * --------------
         * - https://docs.Summertalk.com/Summertalk-sfu/host-protection/
         */
        host: {
            ...
            users_api_secret_key: process.env.USERS_API_SECRET || 'Summertalkweb_default_secret',
            users_api_endpoint: process.env.USERS_API_ENDPOINT || 'http://localhost:9000/api/v1/user/isAuth', // 'https://webrtc.Summertalk.com/api/v1/user/isAuth'
            users_api_room_allowed:
                process.env.USERS_ROOM_ALLOWED_ENDPOINT || 'http://localhost:9000/api/v1/user/isRoomAllowed', // 'https://webrtc.Summertalk.com/api/v1/user/isRoomAllowed'
            users_api_rooms_allowed:
                process.env.USERS_ROOMS_ALLOWED_ENDPOINT || 'http://localhost:9000/api/v1/user/roomsAllowed', // 'https://webrtc.Summertalk.com/api/v1/user/roomsAllowed'
            api_room_exists: process.env.ROOM_EXISTS_ENDPOINT || 'http://localhost:9000/api/v1/room/exists', // 'https://webrtc.Summertalk.com//api/v1/room/exists'
            ...
            presenters: {
                list: process.env.PRESENTERS
                    ...
                    : ['Samar Hassine', 'Summerslav.pejic.85@gmail.com'],
     ...
     * API Documentation:
     * ------------------
     * - Complete API reference: https://docs.Summertalk.com/Summertalk-sfu/api/
     * - Webhook setup: See integration guides for Slack/Mattermost
     */
    api: {
        keySecret: process.env.API_SECRET || 'Summertalksfu_default_secret',
        allowed: {
    ...
    integrations: {
         ...
         *                (default: Streaming avatar instructions for SummerTalk)
         */
        videoAI: {
            enabled: process.env.VIDEOAI_ENABLED === 'true',
            basePath: 'https://api.heygen.com',
            apiKey: process.env.VIDEOAI_API_KEY || '',
            systemLimit: process.env.VIDEOAI_SYSTEM_LIMIT || 'You are a streaming avatar from SummerTalk...',
        },
        ...
        email: {
            ...
            sendTo: process.env.EMAIL_SEND_TO || 'sfu.Summertalk@gmail.com',
        },
            ...
            commands: [
                {
                    ...
                    message: process.env.MATTERMOST_DEFAULT_MESSAGE || 'Here is your TALK room:',
                },
            ],
            texts: [
                {
            ...
            commands: [
                {
                    ...
                    baseUrl: process.env.DISCORD_BASE_URL || 'https://sfu.Summertalk.com/join/',
                },
            ],
        },
         ...
         *      - Project demo: /Summertalksfu/webhook/ folder
         */
        webhook: {
         ...
         *    - Click "Create bucket"
         *    - Choose unique name (e.g., 'Summertalk')
        ...
        aws: {
            ...
            bucket: process.env.AWS_S3_BUCKET || 'Summertalk',
        },
    },
    ...
    ui: {
         ...
         * LICENSE REQUIRED:
         * ----------------
         * - https://codecanyon.net/item/Summertalk-sfu-webrtc-realtime-video-conferences/40769970
         */
        brand: {
            /**
            ...
            app: {
                ...
                name: process.env.APP_NAME || 'SummerTalk',
                title:
                    process.env.APP_TITLE ||
                    '<h1>SummerTalk</h1> Free browser based Real-time video calls.<br />Simple, Secure, Fast.',
                description:
             ...
             */
            site: {
                title: process.env.SITE_TITLE || 'SummerTalk ',
                icon: process.env.SITE_ICON_PATH || '../images/logo.svg',
                appleTouchIcon: process.env.APPLE_TOUCH_ICON_PATH || '../images/logo.svg',
                newRoomTitle: process.env.NEW_ROOM_TITLE || 'Pick A name <3',
                newRoomDescription:
                    process.env.NEW_ROOM_DESC || 'Take your Time',
            },
            ...
            meta: {
                description:
                    ...
                    'SummerTalk powered by WebRTC and mediasoup for real-time video communications.',
                keywords: process.env.META_KEYWORDS || 'webrtc, video calls, conference, screen sharing, Summertalk, sfu',
            },
            ...
            og: {
                ...
                siteName: process.env.OG_SITE_NAME || 'SummerTalk',
                title: process.env.OG_TITLE || 'Click the link to make a call.',
                description:
                    process.env.OG_DESCRIPTION || 'SummerTalk provides real-time video calls and screen sharing.',
                image: process.env.OG_IMAGE_URL || 'https://sfu.Summertalk.com/images/Summertalksfu.png',
                url: process.env.OG_URL || 'https://sfu.Summertalk.com',
            },
             ...
             */
            about: {
                imageUrl: process.env.ABOUT_IMAGE_URL || '../images/Summertalk-logo.gif',
                title: `WebRTC SFU v${packageJson.version}`,
                html: `
                    <button id="support-button" data-umami-event="Support button"
                        onclick="window.open('${process.env.SUPPORT_URL || 'https://codecanyon.net/user/Samar'}', '_blank')">
                    ...
                    <a id="linkedin-button" data-umami-event="Linkedin button"
                        href="${process.env.LINKEDIN_URL || 'https://www.linkedin.com/in/Summerslav-pejic-976a07101/'}" 
                        target="_blank">
                        ${process.env.AUTHOR_NAME || 'Samar Hassine'}
                    </a>
                    <br />
                    <br />
                    ${process.env.EMAIL_LABEL || 'Email'}: 
                    <a id="email-button" data-umami-event="Email button"
                        href="mailto:${process.env.CONTACT_EMAIL || 'Summerslav.pejic.85@gmail.com'}?subject=${process.env.EMAIL_SUBJECT || 'SummerTalk info'}">
                        ${process.env.CONTACT_EMAIL || 'Summerslav.pejic.85@gmail.com'}
                    </a>
                    <hr />
                    <span>
                        &copy; ${new Date().getFullYear()} ${process.env.COPYRIGHT_TEXT || 'SummerTalk, all rights reserved'}
                    </span>
                    <hr />
                    `,
            },
    ...
    features: {
        ...
        stats: {
            ...
            src: process.env.STATS_SRC || 'https://stats.Summertalk.com/script.js',
     ...
     * ==============================
     * Core WebRTC components powering SummerTalk
     *
     * Essential Links:
     * ---------------
    ...
    mediasoup: {
         ...
         */
        webRtcServerActive: 'true', // Enable if SFU_SERVER=true
        webRtcServerOptions: {
            listenInfos: [
                {
                    protocol: 'udp',
                    ip: '0.0.0.0',
                    announcedAddress: '18.196.185.52',
                    portRange: { min: 40000, max: 40000 + NUM_WORKERS }
                  },
                  {
                    protocol: 'tcp',
                    ip: '0.0.0.0',
